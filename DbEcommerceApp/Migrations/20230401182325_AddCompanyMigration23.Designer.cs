...
namespace DbEcommerceApp.Migrations
{
    ...
    [Migration("20230401182325_AddCompanyMigration23")]
    partial class AddCompanyMigration23
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DbEcommerceApp.Data.Models.OrderProduct", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("DbEcommerceApp.Data.Models.UserDetail", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("DbEcommerceApp.Data.Models.OrderProduct", b =>
                {
                    b.HasOne("DbEcommerceApp.Data.Models.Order", "Order")
            ...
            modelBuilder.Entity("DbEcommerceApp.Data.Models.Product", b =>
                {
                    b.HasOne("DbEcommerceApp.Data.Models.Category", "Category")
                        .WithMany("Products")
            ...
            modelBuilder.Entity("DbEcommerceApp.Data.Models.UserDetail", b =>
                {
                    b.HasOne("DbEcommerceApp.Data.Models.User", "User")
                        .WithOne("UserDetail")
                        .HasForeignKey("DbEcommerceApp.Data.Models.UserDetail", "UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
